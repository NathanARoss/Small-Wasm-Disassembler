      ...
      while (offset < wasm.length) {
        ...
        while (offset < end) {
          switch (sectionCode) {
            ...
            case Wasm.section.Table: {
                printDisassembly(1, "element type: " + Wasm.typeNames[wasm[offset]]);
            ...
            case Wasm.section.Export: {
                ...
                const exportType = wasm[offset];
                const exportTypeName = Wasm.externalKindNames[exportType];
